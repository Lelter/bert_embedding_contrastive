...
def create_embedding_matrix(feature_columns, total_vocabulary_size, init_std=0.0001, linear=False, sparse=False,
                            device='cpu'):
    ...
    # nn.init.xavier_normal_(embedding_dict['all'].weight)
